...
/* Array of 20 priority queues */
static struct list mlfq[NumPRI];
/* time tracker for priority S*/
static int ticks_since_S;
...
init_thread(struct thread *t, const char *name, int priority)
{
  ...
  // To initialize MLFQ fields
  if (thread_mlfqs)
  {
    // since all new threads begin at the highest priority
    t->priority = PRI_MAX;
    t->ticks_used_atCurrLevel = 0;
    t->quant_forCurrLevel = TIME_SLICE;
  }
